...
interface OfferCardProps {
  offer: Offer;
  locale: Locale;
  index?: number; // Added index to prioritize the first few cards for LCP
}
...
const OfferCard = ({ offer, locale, index = 0 }: OfferCardProps) => {
  ...
  // We prioritize the first 2 images to load immediately to boost LCP scores.
  ...
  return (
    ...
    >
      {/* 1. THE "TYPE" STRIP - Solid black prevents visibility issues */}
      ...
      {/* 2. IMAGE HERO AREA - Relative container is required for Image fill */}
      <div className="relative flex-[1.5] flex items-center justify-center m-4 overflow-hidden">
        
        {/* Background Decorative Text (Cheap Flyer Vibe) */}
        ...
        {/* PRICE TAG - Forced High Contrast */}
        <div 
      ...
      {/* 3. INFO BOX - The "Shield" for Legibility */}
      <div className="z-20 m-4 mt-0 bg-black/40 backdrop-blur-md border-4 border-black p-5 flex flex-col justify-between flex-1">
        ...
        <div className="mt-4 flex flex-col gap-3">
            ...
            <div className="flex items-end justify-between gap-2">
                ...
                <div 
                    className="h-12 w-12 flex items-center justify-center border-[3px] border-black shadow-[3px_3px_0px_0px_#000] active:shadow-none active:translate-x-0.5 active:translate-y-0.5 transition-all cursor-pointer"
                    style={{ backgroundColor: accent }}
                >
                    <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="black" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round"><path d="M5 12h14"/><path d="m12 5 7 7-7 7"/></svg>
                </div>
            </div>
        </div>
      </div>
