            ...
            <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                    {otherBevs.filter(i => ['bev-001', 'bev-002', 'bev-003'].includes(i.id)).map(x => (
                        <div key={x.id} className="flex flex-col border-l-2 border-gray-200 pl-4 py-2">
        ...
        <div className="max-w-3xl mx-auto w-full px-4 mt-20 text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-left">
                <div className="bg-amber-50 p-6 rounded-2xl border-2 border-amber-900/10">
                    ...
                    <p className="text-sm font-bold leading-tight">Boosts physical performance by increasing adrenaline levels and provides a rich source of essential antioxidants.</p>
                </div>
                <div className="bg-green-50 p-6 rounded-2xl border-2 border-green-800/10">
                    ...
                    <p className="text-sm font-bold leading-tight">Contains L-theanine which promotes relaxation without drowsiness, leading to a state of &ldquo;calm alertness.&rdquo;</p>
                </div>
            </div>
        </div>
    </div>
